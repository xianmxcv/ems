...
const GasMeter = () => {
  ...
  const getList = useCallback(async () => {
    try {
      const { data = [] } = await api.getMeterList({ emMeterType: IMeterType.GASMETER })
      ...
      >
        ...
        <Row style={{ minHeight: 160, paddingTop: 24, fontSize: 14 }} justify="center">
          <Col span={6} style={{ textAlign: 'center' }}>
            ...
            >
              {IGasMeterTypeName[electric.emType]}
            </div>
          </Col>
          <Col span={18}>
            <Row style={{ minHeight: 36 }} wrap={false}>
              <Col span={12} className={styles.col_2}>
                <span className={styles.col_1}>燃气表名称：</span> {electric.emName}
              </Col>
              <Col span={12} className={styles.col_2}>
            ...
            <>
              ...
              >
                ...
                <Form.Item
                  ...
                  name="P_FLOW"
                  rules={[
                    { required: true, message: '正向累计流量必填' },
                    {
                ...
                >
                  <Input style={{ width: 217 }} suffix="m³" />
                </Form.Item>
                <Form.Item
                  label="反向累计流量"
                  name="R_FLOW"

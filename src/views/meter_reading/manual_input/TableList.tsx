...
const TableList = (props: Iprops) => {
  ...
  const columns: ColumnType<IResIElectricMeterPage>[] = [
    ...
    },
    {
      ...
      width: 150,
      render: (text, row) =>
        `${row.mrecTime ? moment(row.mrecTime).format('YYYY-MM-DD HH:mm:ss') : '--'}`,
    },
    {
      title: '有功总电能',
      dataIndex: 'ep',
